...
$dbi->addBreadcrumb (Z_HELPTEXTS,'z_list_helptexts.php');
...
$form->addField ('name',TEXT,30,REQUIRED)				->setLabel (Z_HELPTEXT_NAME);
$form->addField ('permission',TEXT,15,REQUIRED)			->setLabel (Z_HELPTEXT_PERMISSION);
$form->addField ('title_'.USER_LANGUAGE,TEXT,120)		->setLabel (Z_HELPTEXT_TITLE);
$form->addField ('content_'.USER_LANGUAGE,TEXTAREA,20)	->setLabel (Z_HELPTEXT_CONTENT);
...
$layout
	->set('title',getUrlParameter('textblock_id') ? Z_EDIT_HELPTEXT : Z_NEW_HELPTEXT)
