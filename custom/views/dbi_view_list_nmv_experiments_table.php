...
class View_List_NMV_Experiments_Table extends View_List {
	...
	static public function create () {
		...
		switch (func_num_args()) {
			...
			case 2: return new View_List_NMV_Experiments_Table ($args[0], $args[1]);
		}
	}
	...
	public function get_HTML ($results) {
		...
		if ($results->num_rows>0) {
		    ...
		    $html .= '<th>ID</th><th>Title</th><th>Institutions</th><th>Fields of Interest</th><th>Objective</th><th>Start Year</th><th>End Year</th><th>Options</th>';
