...
class View_List_results_NMV_Victims extends View_List {
	...
	static public function create () {
		...
		switch (func_num_args()) {
			case 1: return new View_List_results_NMV_Victims ($args[0]);
		}
	}
	...
	public function get_HTML ($results) {
		...
		if ($results->num_rows>0) {
		    ...
		    $html .= '<th>Main Name</th><th>ID</th><th>Options</th>';
			while ($item = $results->fetch_object()) {
			    $html .= '<tr>
			        <td><a href="nmv_view_victim?ID_victim=' . $item->ID_victim . '">' . htmlentities($item->surname, ENT_HTML5) . ' ' . htmlentities($item->first_names, ENT_HTML5) . '</a></td>
