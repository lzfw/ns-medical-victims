...
$querystring_count = 'SELECT COUNT(*) AS total FROM nmv__nationality b'; // für Treffer gesamt
$querystring_items = 'SELECT ID_nationality, english, deutsch
                      FROM nmv__nationality b';
