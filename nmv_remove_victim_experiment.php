...
function breadcrumb($dbi, $item, $record_id) {
    ...
    $dbi->addBreadcrumb ($vict_exp_name,'nmv_view_victim_experiment?ID_victim='.$item->ID_victim);
}
...
function prompt($dbi, $item) {
    ...
    return 'Remove victim biomedical research '.': "<em>'.$victim_experiment.'</em>".';
}
...
remove_record('ID_vict_exp', 'ID_vict_exp', 'nmv__victim_experiment',
    'Victim Biomedical Research', 'nmv_list_victim_experiment', 'nmv_list_victim_experiment',
