...
class Field_SubtableComp extends Field {
	...
	protected function __construct (Form $Creator, $name, $subtable_key_column, $subtable_value_column, $required) {
		if (isset($name)) {
	...
	static public function create() {
		...
		switch (func_num_args()) {
			case 2: return new Field_SubtableComp ($args[0],$args[1],NULL,NULL,NULL);
			case 3: return new Field_SubtableComp ($args[0],$args[1],$args[2],NULL,NULL);
			case 4: return new Field_SubtableComp ($args[0],$args[1],$args[2],$args[3],NULL);
			case 5: return new Field_SubtableComp ($args[0],$args[1],$args[2],$args[3],$args[4]);
