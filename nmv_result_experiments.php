...
$exact_fields = array ('ID_experiment');
...
$querystring_items = 'SELECT e.ID_experiment, e.experiment_title, e.funding,
                        e.field_of_interest, e.objective FROM nmv__experiment e'; // für Ergebnisliste
...
$suche_nach = array();
if (isset($_GET['ID_experiment']) && $_GET['ID_experiment']) $suche_nach[] = 'ID_experiment = '.$_GET['ID_experiment'];
if (isset($_GET['experiment_title']) && $_GET['experiment_title']) $suche_nach[] = 'experiment_title = '.$_GET['experiment_title'];
if (isset($_GET['funding']) && $_GET['funding']) $suche_nach[] = 'funding = '.$_GET['funding'];
if (isset($_GET['field_of_interest']) && $_GET['field_of_interest']) $suche_nach[] = 'field_of_interest = '.$_GET['field_of_interest'];
...
$layout
	...
	->set('content',
        ...
        .$dbi->getListView('nmv_experiments',$query_items)
        .'<div class="buttons">'
