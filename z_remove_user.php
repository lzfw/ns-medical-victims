...
$layout
	...
	->set('content',
		...
		buildElement('div','buttons',
			createButton (L_NO_CANCEL,'z_remove_user?user_id='.$item_id.'&confirm=no','icon no').
			createButton (L_YES_CONTINUE,'z_remove_user?user_id='.$item_id.'&confirm=yes','icon yes')
		)
	)
	->cast();
