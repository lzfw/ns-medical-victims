...
$diagnosesForm->addField('keyword_info', STATIC_TEXT, 'Returns victims with given keyword in: <br>cause of death, hospitalisation diagnosis, brain report diagnosis (in tags and/or freetext)<hr>');
