...
$querystring_items = 'SELECT v.ID_perpetrator, v.surname, v.first_names, v.birth_year, v.birth_country, v.birth_place, v.occupation FROM nmv__perpetrator v'; // für Ergebnisliste
